...
class _UploadDataState extends State<UploadData> {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              FlatButton(
                  ...
                  child: Icon(Icons.add_a_photo,size: 80,color: Color(0xff00bcd4),)
              ):
  ...
  Future<void> upload() async{
    if(formKey.currentState.validate()) {
      StorageReference reference = FirebaseStorage.instance.ref().child("images").child(new DateTime.now().millisecondsSinceEpoch.toString() + "." + imageFile.path);
